namespace Actividad_2._1_Diseño_e_implenacion_de_Modelos
{
    partial class FrmDonante
    {
        ...
        {
            lblRazonSocialONombre = new Label();
            txtRazonSocialONombre = new TextBox();
            lblTipoDonante = new Label();
            cmbTipoDonante = new ComboBox();
            ...
            grpDatos.Text = "Datos de Donante";
            // 
            // tlpCampos
            // 
            ...
            tlpCampos.Controls.Add(lblRazonSocialONombre, 0, 0);
            tlpCampos.Controls.Add(txtRazonSocialONombre, 1, 0);
            tlpCampos.Controls.Add(lblTipoDonante, 0, 1);
            tlpCampos.Controls.Add(cmbTipoDonante, 1, 1);
            ...
            // 
            // lblRazonSocialONombre
            // 
            lblRazonSocialONombre.Anchor = AnchorStyles.Left;
            lblRazonSocialONombre.AutoSize = true;
            lblRazonSocialONombre.Location = new Point(3, 12);
            lblRazonSocialONombre.Name = "lblRazonSocialONombre";
            lblRazonSocialONombre.Size = new Size(110, 15);
            lblRazonSocialONombre.TabIndex = 0;
            lblRazonSocialONombre.Text = "Razón social / Nombre:";
            // 
            // txtRazonSocialONombre
            // 
            txtRazonSocialONombre.Anchor = AnchorStyles.Left | AnchorStyles.Right;
            txtRazonSocialONombre.Location = new Point(168, 8);
            txtRazonSocialONombre.MaxLength = 120;
            txtRazonSocialONombre.Name = "txtRazonSocialONombre";
            txtRazonSocialONombre.Size = new Size(343, 23);
            txtRazonSocialONombre.TabIndex = 1;
            // 
            // lblTipoDonante
            // 
            lblTipoDonante.Anchor = AnchorStyles.Left;
            lblTipoDonante.AutoSize = true;
            lblTipoDonante.Location = new Point(3, 12);
            lblTipoDonante.Name = "lblTipoDonante";
            lblTipoDonante.Size = new Size(110, 15);
            lblTipoDonante.TabIndex = 2;
            lblTipoDonante.Text = "Tipo de donante:";
            // 
            // cmbTipoDonante
            // 
            cmbTipoDonante.Anchor = AnchorStyles.Left;
            cmbTipoDonante.DropDownStyle = ComboBoxStyle.DropDownList;
            cmbTipoDonante.FormattingEnabled = true;
            cmbTipoDonante.Items.AddRange(new object[] { "Persona", "Empresa" });
            cmbTipoDonante.Location = new Point(168, 8);
            cmbTipoDonante.Name = "cmbTipoDonante";
            cmbTipoDonante.Size = new Size(180, 23);
            cmbTipoDonante.TabIndex = 3;
            // 
            // lblEstadoActivo
            // 
        ...
        private Label lblRazonSocialONombre;
        private TextBox txtRazonSocialONombre;
        private Label lblTipoDonante;
        private ComboBox cmbTipoDonante;
